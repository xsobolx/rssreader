...
public class RssDatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<RssFeedItem> getAllItems() {
    ...
    public void addSites() {
        WebSite nyTimesWorld =
                new WebSite("NY Times World", "http://tutorialspoint.com/android/sampleXML.xml/");
        addSite(nyTimesWorld);
        WebSite economist =
